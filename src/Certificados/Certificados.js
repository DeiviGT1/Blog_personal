...
function Certificados(){
  ...
  const lstCourseraDesc = [ExcelAdvancedDesc,            
    ExcelBusinessDesc,
    GoogleITDesc,
    PostgreSQLforEverybodyDesc,
    PythonforEverybodyDesc,
    ]
  const lstCoursera = [ExcelAdvanced,            
    ExcelBusiness,
    GoogleIT,
  ...
  const lstMachineLearning = [MachineLearningMindsDB,
    RedesNeuronalesConv,
    RedesNeuronalesTf,
  ...
  const lstBasesDeDatosDesc = [
    FundamentosBDDesc,
    PostgreSQLDesc,
    SparkDesc
  ]
  const lstBasesDeDatos = [FundamentosBD,
    PostgreSQL,
    Spark,
    ]
